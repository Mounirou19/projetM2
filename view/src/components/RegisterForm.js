 ...
 * Styles : ../css/Auth.css (importé par RegisterPage)
 */
                ...
                <form onSubmit={handleSubmit} className="register-form" noValidate>
                    <div className="form-row">
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Votre prénom" required disabled={loading}
                            />
                        ...
                        <div className="form-group">
                            ...
                            <input
                                ...
                                placeholder="Votre nom" required disabled={loading}
                            />
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder="votre.email@exemple.com" required disabled={loading}
                        />
                    ...
                    <div className="form-group">
                        ...
                        {formData.password && (
                            <div className={`password-strength strength-${passwordStrength.toLowerCase()}`}>
                                <span className="strength-bar"><i></i></span>
                                Force : <strong>{passwordStrength}</strong>
                            </div>
                        )}
                        {errors.password && <span className="error-message">{errors.password}</span>}
                        <small className="form-hint">
                            8 caractères min., une majuscule, une minuscule, un chiffre et un caractère spécial (@$!%*?&amp;)
                        </small>
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input
                            ...
                            placeholder="Retapez votre mot de passe" required disabled={loading}
                        />
                    ...
                    <div className="form-group rgpd-consent">
                        <label className="checkbox-label">
                            <input
                                type="checkbox" name="rgpdConsent"
                            ...
                            <span>
                                J'accepte la{' '}
                                <button type="button" className="link-button" onClick={onShowRgpdModal}>
                                    politique de confidentialité
                                </button>
                                {' '}et le traitement de mes données personnelles conformément au RGPD *
                            </span>
                        </label>
                        {errors.rgpdConsent && <span className="error-message">{errors.rgpdConsent}</span>}
                    </div>
                    ...
                    <button type="submit" className="btn-submit" disabled={loading || !captchaToken}>
                        {loading ? (<><span className="spinner"></span>Inscription en cours...</>) : ("S'inscrire")}
                    </button>

                    <p className="form-footer">
                        Vous avez déjà un compte ? <a href="/login" className="link">Se connecter</a>
                    </p>
                </form>
            </div>
        </div>
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="modal-body">
                    ...
                    <p>CinéManga s'engage à protéger vos données personnelles conformément au RGPD.</p>
                    ...
                    <h4>Contact :</h4>
                    <p>Pour exercer vos droits : <br /><strong>mounirou.cisse@ensitech.eu</strong></p>
                ...
                <div className="modal-footer">
                    <button className="btn-primary" onClick={onClose}>J'ai compris</button>
                </div>
            </div>
        </div>
    );
